// /pages/upload-history-signed-filter.tsx
...
export default function UploadHistorySignedFilterPage() {
  ...
  const applyFilters = () => {
    ...
    setSignedResults([]); // フィルタ変更時はURLリセット
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">署名付きURL履歴リスト（検索フィルタ付き）</h1>
